...
public final class Content {
    ...
    static {
        ...
        TABS.register("cultivation",()->CreativeModeTab.builder().title(Component.literal("DuskRain · 烟雨仙途")).icon(()->new ItemStack(ARTIFACTS.get(0).get())).displayItems((p,o)->{ARTIFACTS.forEach(a->o.accept(a.get()));PILLS.forEach(a->o.accept(a.get()));Boosts.ITEMS.forEach(a->o.accept(a.get()));Outfits.ALL.forEach(a->o.accept(a.get()));o.accept(MysticEnchants.SAND.get());o.accept(Ascension.CORE.get());o.accept(Ascension.CRYSTAL.get());o.accept(WAYFINDER.get());o.accept(Decor.EXPLORER.get());Architecture.ALL.values().forEach(b->o.accept(b.get()));}).build());
    }
