...
public final class Gameplay {
    ...
    @SubscribeEvent public void serverTick(TickEvent.ServerTickEvent e){if(e.phase==TickEvent.Phase.END){ArchitectureRepair.tick(e.getServer());Guilds.tick(e.getServer());GuildPalace.tick(e.getServer());WildernessTravel.tick(e.getServer());SignRepair.tick(e.getServer());Skills.tick(e.getServer());Services.tick(e.getServer());Trials.tick(e.getServer());Construction.tick(e.getServer());}}
